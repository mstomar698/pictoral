      ...
      <div style={{ marginBottom: '180x', color: '#CCC' }}>
        <div style={{ marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <button
              className={
                'resize-view-btn btn-plus-minus ' +
                (autoAdjustContrast ? 'disabled' : '')
              }
              disabled={autoAdjustContrast}
              onClick={this.onChange}
              data-value-type="brightness"
            ...
            <input
              type="range"
              className={autoAdjustContrast ? 'disabled' : ''}
              disabled={autoAdjustContrast}
              min="-10"
              max="10"
              step="1"
        ...
        >
          ...
          >
            ...
            <div>
              <input
                type="radio"
                id="auto-adjust-contrast"
                checked={this.state.contrastAdjustMode === 'auto'}
                value={this.state.contrastAdjustMode}
                name="color-contrast-adjust"
                className="radio-input"
                style={{ display: 'none' }}
                onChange={this.onChange}
                data-adjust-mode="auto"
              />
              <label htmlFor="auto-adjust-contrast" className="radio-label">
                <span />
              </label>
            </div>
          </div>
          ...
          >
            ...
            <div>
              <input
                type="radio"
                id="manual-adjust-contrast"
                checked={this.state.contrastAdjustMode === 'manual'}
                value={this.state.contrastAdjustMode}
                name="color-contrast-adjust"
                className="radio-input"
                style={{ display: 'none' }}
                onChange={this.onChange}
                data-adjust-mode="manual"
              />
              <label htmlFor="manual-adjust-contrast" className="radio-label">
                <span />
              </label>
            </div>
          </div>

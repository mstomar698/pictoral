        ...
        >
          ...
          <div>
            <input
              ...
              data-value-type="grayscaled"
              data-value-change="set"
            />
            <label htmlFor="toggle-grayscale" className="toggle-label">
              <span />
            </label>
          </div>
        </div>
        ...
        >
          ...
          <div>
            <input
              ...
              onChange={this.onChange}
              data-value-type="inverted"
              data-value-change="set"
            />
            <label htmlFor="toggle-invert" className="toggle-label">
              <span />
            </label>
          </div>
        </div>
        ...
        <div style={{ marginTop: '38px', marginBottom: '18px' }}>
          <div style={{ marginBottom: '24px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <button
                className={
                  'resize-view-btn ' + (hue_sat_disabled ? 'disabled' : '')
                }
                data-value-type="hue"
                data-value-change="down"
                disabled={hue_sat_disabled}
              ...
              <input
                type="range"
                id="color-hue-setter"
                className={hue_sat_disabled ? 'disabled' : ''}
                data-value-type="hue"
                data-value-change="set"
                min="-10"
                max="10"

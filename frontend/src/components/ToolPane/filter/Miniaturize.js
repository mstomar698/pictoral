...
class Miniaturize extends Component {
  ...
  componentDidUpdate = () => {
    ...
    if (
      top_height < 0 ||
      top_height > this.props.imgHeight ||
      bottom_height < 0 ||
      bottom_height > this.props.imgHeight
    ) {
      return;
    }
      ...
      <div style={{ marginBottom: '180x', color: '#CCC' }}>
        ...
        >
          ...
          <div>
            <input
              type="checkbox"
              id="toggle-mini-handlers"
              className="toggle-input"
              style={{ display: 'none' }}
              checked={this.state.handlerVisible}
              onChange={this.toggleHandlers}
            />
            <label htmlFor="toggle-mini-handlers" className="toggle-label">
              <span />
            </label>
          </div>
        </div>
        ...
        >
          ...
          <li className="clickable" id={`${URL_PATH}/img/airport.jpg`}>
            Airport
          </li>
        </ul>
      </div>

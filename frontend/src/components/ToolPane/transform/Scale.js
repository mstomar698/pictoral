        ...
        >
          <div style={{ marginBottom: '18px' }}>
            ...
            <div className="canvas-handler-region-info">
              {Math.round((scale * this.imgWidth) / 100) + ' px'}
            </div>
          </div>
          <div style={{ marginBottom: '18px' }}>
            <label style={{ color: '#a0a0a0', paddingLeft: '4px' }}>
            ...
            <div className="canvas-handler-region-info">
              {Math.round((scale * this.imgHeight) / 100) + ' px'}
            </div>
          </div>
          <div style={{ marginBottom: '18px' }}>
            <label style={{ color: '#a0a0a0', paddingLeft: '4px' }}>
